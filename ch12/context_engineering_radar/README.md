...
- Source Files:
  - HTML structure: [docs/context-engineering-radar.html](/docs/context-engineering-radar.html)
  - Styling system: [docs/css/radar.css](/docs/css/radar.css)
  - Interactive logic: [docs/js/radar-page.js](/docs/js/radar-page.js)
  - JSON data file: [docs/radar-data.json](/docs/radar-data.json)
