...
This example demonstrates the **sequential multi-agent pattern** using n8n, a graph-based workflow automation tool.

The workflow orchestrates a simple content creation process involving three specialized agents connected in a sequence:
